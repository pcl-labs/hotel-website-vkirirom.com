      ...
      <v-container>
        <v-row no-gutters style="min-height: 100vh;">
          <v-flex xs12 md6>
            <v-flex xs12>
              <h1
                style="font-size: 36px; color: #FFFFFF; margin-bottom:43px; margin-top:50px;"
              >
                Contact
              </h1>
            </v-flex>
            ...
            >
              <v-card-text style="padding:30px;">
                <v-flex xs12>
                  ...
                  <p>
                    Preah Soramarith-Kosamak National Park (Kirirom), Phnom
                    Srouch District, Kompong Speu Province, Cambodia
                  </p>
                  <p>
                    <a href="https://goo.gl/maps/NusquSFKVm2SHrDy7"
                      >Get Directions</a
                    >
                  </p>
                </v-flex>
