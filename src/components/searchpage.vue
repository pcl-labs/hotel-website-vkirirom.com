      ...
      <v-flex xs12 class="headerText">
        ...
        <v-flex xs12 v-if="id == 'food'">
          <p>
            ...
            traditional Khmer food. The restaurant strives to create wonderful healthy food that is locally sourced from
            local farmers or grown in vKirirom’s own organic garden.
          </p>
