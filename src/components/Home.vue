    ...
    <v-card dark>
      <div id="header">
        <v-container class="is-limited fill-height align-end justify-start">
          <v-flex xs12>
            <h1 class="headerh1 d-none d-md-flex">
              Book your nature retreat at vKirirom Pine Resort
            </h1>
            <h1 class="headerh1mob d-md-none">
              Book your nature retreat at vKirirom Pine Resort
            </h1>
          </v-flex>
        </v-container>
    ...
    <v-container class="is-limited">
      ...
      <v-row class="cardRow" dense>
        <v-col
          ...
          sm="6"
          md="4"
          v-for="lease in leases.slice(0, 4)"
          v-bind:key="lease.id"
        >
          <v-card
            :ripple="false"
      ...
      <v-row no-gutters class="justify-center">
        <v-flex xs12 sm4 md4 lg4>
          <v-btn
            to="/search/ecotourism/"
            block
            large
            outlined
            dark
            class="showAllbtn mb-6"
          >
            Learn More <v-spacer></v-spacer>
